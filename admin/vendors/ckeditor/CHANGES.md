...
* [#5189](http://dev.ckeditor.com/ticket/5189): Find/Replace dialog window: rename "Cancel" button to "kapat".
...
* [#9761](http://dev.ckeditor.com/ticket/9761): Güncelleştirme *Backspace* key state in `keystrokeHandler#blockedKeystrokes` when calling `editor.setReadOnly()`.
...
* [#10172](http://dev.ckeditor.com/ticket/10172): Pressing *sil*/*Backspace* in an empty table cell moves the cursor to the next/previous cell.
...
* [#10260](http://dev.ckeditor.com/ticket/10260): Fixed: Advanced içerik Filter blocks `tabSpaces`. Unified `data-cke-*` attributes filtering.
...
* [#10192](http://dev.ckeditor.com/ticket/10192): Closing lists with Enter key does not work with Advanced içerik Filter in several cases.
...
* [#10224](http://dev.ckeditor.com/ticket/10224): Advanced içerik Filter does not remove non-empty `<a>` elements anymore.
* Minor issues in plugin integration with Advanced içerik Filter:
  * [#10166](http://dev.ckeditor.com/ticket/10166): Added transformation from the `align` attribute to `float` style to preserve backward compatibility after the introduction of Advanced içerik Filter.
  * [#10195](http://dev.ckeditor.com/ticket/10195): Image plugin no longer registers rules for links to Advanced içerik Filter.
  * [#10213](http://dev.ckeditor.com/ticket/10213): Justify plugin is now correctly registering rules to Advanced içerik Filter when `config.justifyClasses` is defined.
